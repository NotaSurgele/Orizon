...
void GameScene::create()
{
   ...
   dirt.addComponent<Sprite>(R_GET_RESSOURCE(sf::Texture, "grass"), 10, 10);
   ...
   player2.addComponent<Sprite>(R_GET_RESSOURCE(sf::Texture, "hobbit"), 10, 10);
   player2.addComponent<Animator>()->newAnimation(4, AnimatorRect{0, 0, 18, 18}, .2f, "idle");
